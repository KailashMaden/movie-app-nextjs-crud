...
const Home = (props) => {
  ...
  const filterMovies = (movies) => {
    ...
    return movies.filter((item) => {
      return item.genre && item.genre.includes(filter);
    });
  };
...
Home.getInitialProps = async () => {
  const movies = await getMovies(); //receiving data from actions/index.js function getMovies
...
//   //Is Called only once when component is mounted!
//   // componentDidMount() {
//   //   getMovies()
//   //     .then((movies) => {
